 ...
 *       Filename:  apue.h
 *
 *    Description:  our own header,
 *                  to be include before all standard system headers.
 *
 *        Version:  1.0
 *        Created:  10/14/2017 02:45:41 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
...
#if defined(SOLARIS)
#define _XOPEN_SOURCE 600       /* Solaris 10 */
#else
...
#if defined(MACOS) || !defined(TIOCGWINZE)
#include <sys/ioctl.h>
#endif
 ...
 */
char    *path_malloc(size_t *);             /* Figure 2.16 */
...
ssize_t writen(int, const void *, size_t);  /* Figure 14.25 */
